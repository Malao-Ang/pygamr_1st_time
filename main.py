...
icon = pygame.image.load('public/png/logo.png')  # โหลดรูปเข้ามาในpygame
pygame.display.set_icon(icon)  # set icon

background = pygame.image.load('public/png/bg.png')
########################################################################
# 1. player - finger.png
psize = 128  # ความกว้างของภาพman
pimg = pygame.image.load('public/png/ufo.png')
...
# 2. enermy - tooกับO
esize = 64
eimg = pygame.image.load('public/png/E_Too.png')
ex = 50
ey = 0
eychange = 3
...
# 3. กระสุน
bsize = 32
bimg = pygame.image.load('public/png/Bom.png')
bx = 100
by = HEIGHT-psize
bychange = 20
bstate = 'ready'
...
def showscore():
    score = font.render('Point : {} Point'.format(
        allscore), True, (255, 255, 255))
    screen.blit(score, (30, 30))

# Sound #
pygame.mixer.music.load('public/music/game.wav')
pygame.mixer.music.set_volume(0.5)
pygame.mixer.music.play(-1)

sound = pygame.mixer.Sound('public/music/start.wav')
...
def GameOver():
    ...
    if playsound == False:
        gsound = pygame.mixer.Sound('public/music/over.wav')
        gsound.play()
        playsound = True
    '''if gameover == False:
        gameover = True'''
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bstate == 'ready':
                    b1 = pygame.mixer.Sound('public/music/iba.mp3')
                    b1.play()
